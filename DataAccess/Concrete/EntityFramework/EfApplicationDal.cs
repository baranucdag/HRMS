            ...
            using (var context = new DataContext())
            {
                var result = from t1 in context.Applications
                             ...
                             select new ApplicationDto
                             {
                                 ...
                                 ApplicationStatusText = t1.ApplicationStatus.ToString(),
                                 ApplicationStatus = Convert.ToInt32(t1.ApplicationStatus),
                                 PrevApplicationStatus = Convert.ToInt32(t1.PrevApplicationStatus),
                                 HasEmailSent = t1.HasEmailSent,
                                 CandidateCvPath = t2.CvPath,
                                 PrevApplicationStatusText = t1.PrevApplicationStatus.ToString(),
